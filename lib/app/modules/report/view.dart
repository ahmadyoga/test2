...
class ReportPage extends StatelessWidget {
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  _buildStates(Colors.green, liveTask, 'LiveTask'),
                  _buildStates(Colors.orange, completedTask, 'Complated task'),
                  _buildStates(Colors.blue, createdTask, 'Created Task'),
                ],
              ),
            ),
            SizedBox(
  ...
  Row _buildStates(Color color, int number, String text) {
    return Row(
